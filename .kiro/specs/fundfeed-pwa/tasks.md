...
- [x] 1. Initialize Next.js 14 project with TypeScript and dependencies
  ...
  - Install dependencies: Firebase SDK, Tailwind CSS, canvas-confetti, fast-check
...
- [x] 2. Set up Firebase configuration and TypeScript types





  - Create Firebase project configuration in lib/firebase.ts
  - Define TypeScript interfaces for FundraisingRound, User, IntroRequest
  - Create environment variable template for Firebase credentials
  - _Requirements: 4.1, 9.2_

- [x] 3. Implement authentication system

- [x] 3.1 Create Firebase Auth helpers and AuthContext


  - Implement Firebase Auth initialization in lib/auth.ts
...
- [x] 5. Create Firestore helpers and data layer




- [x] 5.1 Implement Firestore CRUD operations
...
- [x] 5.3 Implement Firebase Storage helpers
...
- [x] 7.1 Create FollowButton component
  ...
  - Update Firestore user document on follow/unfollow
...
- [x] 8.1 Create homepage (app/page.tsx)
  ...
  - Fetch fundraising rounds from Firestore
...
- [x] 9.3 Implement form submission with file uploads
  ...
  - Upload logo and deck to Firebase Storage
  - Create Firestore document with round data
...
- [x] 11.4 Create API route for intro requests
  ...
  - Store request in Firestore with all required fields
...
- [x] 13. Configure Firebase Security Rules


  - Write Firestore security rules for fundraising_rounds, users, intro_requests
  - Write Storage security rules for logos and decks with size/type validation
